...
const Dashboard = () => {
  ...
  const { data: salesData, isLoading: salesLoading } = useQuery({
    ...
    queryFn: () => mockApi.getSalesData('7d')
  });
  ...
  const statCards = [
    {
      ...
      value: stats?.todaySales?.toLocaleString('fr-FR', { style: 'currency', currency: 'EUR' }) || '€0',
      change: '+12.5%',
      icon: DollarSign,
    ...
    },
    {
      ...
      value: stats?.totalSales?.toLocaleString('fr-FR', { style: 'currency', currency: 'EUR' }) || '€0',
      change: '+8.2%',
      icon: TrendingUp,
      color: 'text-blue-600',
